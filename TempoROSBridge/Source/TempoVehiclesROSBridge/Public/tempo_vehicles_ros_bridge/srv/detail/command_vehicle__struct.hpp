...
//  tempo_vehicles_ros_bridge::srv::CommandVehicle_Request_<std::pmr::polymorphic_allocator<void>>;
//#else
...
//  tempo_vehicles_ros_bridge::srv::CommandVehicle_Response_<std::pmr::polymorphic_allocator<void>>;
//#else
//// alias to use template instance with default allocator
//using CommandVehicle_Response =

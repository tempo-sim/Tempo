...
// template struct ROSIDL_TYPESUPPORT_CPP_PUBLIC tempo_vehicles_ros_bridge::srv::GetCommandableVehicles_Request_<std::allocator<void>>;
// template struct ROSIDL_TYPESUPPORT_CPP_PUBLIC tempo_vehicles_ros_bridge::srv::GetCommandableVehicles_Request_<std::pmr::polymorphic_allocator<void>>;
...
// Explicitly instantiate and export both versions of the message so that its symbols will be generated.
// template struct ROSIDL_TYPESUPPORT_CPP_PUBLIC tempo_vehicles_ros_bridge::srv::GetCommandableVehicles_Response_<std::allocator<void>>;
// template struct ROSIDL_TYPESUPPORT_CPP_PUBLIC tempo_vehicles_ros_bridge::srv::GetCommandableVehicles_Response_<std::pmr::polymorphic_allocator<void>>;

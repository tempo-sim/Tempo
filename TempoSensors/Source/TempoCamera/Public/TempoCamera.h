...
public:
    ...
    // --- LENS SETTINGS ---
    /** The desired Field of View of the final, distorted image.
     * This drives the Engine's FOV automatically to ensure the frame is filled. */
...
protected:
    ...
    float FindRequiredSourceFOV(float TargetDistortedFOV) const;
};
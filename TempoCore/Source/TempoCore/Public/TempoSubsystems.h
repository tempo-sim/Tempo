...
UCLASS(Abstract)
class TEMPOCORE_API UTempoGameInstanceSubsystem : public UGameInstanceSubsystem
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class TEMPOCORE_API UTempoWorldSubsystem : public UWorldSubsystem
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class TEMPOCORE_API UTempoGameWorldSubsystem : public UTempoWorldSubsystem
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class TEMPOCORE_API UTempoTickableWorldSubsystem : public UTickableWorldSubsystem
{
	GENERATED_BODY()
...
UCLASS(Abstract)
class TEMPOCORE_API UTempoTickableGameWorldSubsystem : public UTempoTickableWorldSubsystem
{
	GENERATED_BODY()

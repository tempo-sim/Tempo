...
def write_project_cargo_toml(project_crate_dir: Path, crate_name: str, tempo_crate_dir: Path,
    ...
    cargo_toml.write_text(f'''# Copyright Tempo Simulation, LLC. All Rights Reserved
#
# Auto-generated by gen_rust_api.py. Do not edit.
...
version = "0.1.0"
edition = "2021"
description = "Project-specific Rust client API; layers project protos on top of tempo-sim."
# TODO: pick the SPDX license that fits this project before publishing — `Apache-2.0` is a
# placeholder so `cargo build` is quiet; replace it with the project's actual license
# (and bundle a LICENSE file via `include = [...]` if you want it in the .crate).
license = "Apache-2.0"

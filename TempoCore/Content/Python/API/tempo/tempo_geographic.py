...
import TempoGeographic.Geographic_pb2_grpc, TempoGeographic.Geographic_pb2, TempoCore.Empty_pb2
async def _set_date(
    day: int = 0,
    month: int = 0,
    year: int = 0
...
import TempoGeographic.Geographic_pb2_grpc, TempoGeographic.Geographic_pb2, TempoCore.Geometry_pb2, TempoCore.Empty_pb2
async def _set_geographic_reference(
    origin: TempoGeographic.Geographic_pb2.GeographicCoordinate = None,
    rotation: TempoCore.Geometry_pb2.Rotation = None
) -> TempoCore.Empty_pb2.Empty:
    stub = await tempo_context().get_stub(TempoGeographic.Geographic_pb2_grpc.GeographicServiceStub)
    request = TempoGeographic.Geographic_pb2.GeographicReference(
        origin=origin,
        rotation=rotation
    )

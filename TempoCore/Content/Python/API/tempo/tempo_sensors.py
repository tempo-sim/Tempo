...
import TempoSensors.Sensors_pb2_grpc, TempoSensors.Sensors_pb2
...
async def _stream_bounding_boxes(
    owner_name: str = '',
    sensor_name: str = ''
) -> TempoCamera.Camera_pb2.BoundingBoxes:
    stub = await tempo_context().get_stub(TempoSensors.Sensors_pb2_grpc.SensorServiceStub)
    request = TempoCamera.Camera_pb2.BoundingBoxesRequest(
        owner_name=owner_name,
        sensor_name=sensor_name
    )
...
import TempoLidar.Lidar_pb2, TempoSensors.Sensors_pb2_grpc
async def _stream_lidar_scans(
    owner_name: str = '',
    sensor_name: str = ''
) -> TempoLidar.Lidar_pb2.LidarScanSegment:
    stub = await tempo_context().get_stub(TempoSensors.Sensors_pb2_grpc.SensorServiceStub)
    request = TempoLidar.Lidar_pb2.LidarScanRequest(
        owner_name=owner_name,
        sensor_name=sensor_name
    )

...
void UTempoIntersectionControlComponent::SetupTrafficControllerMeshData()
{
	...
	for (int32 ConnectionIndex = 0; ConnectionIndex < NumConnections; ++ConnectionIndex)
	{
		...
		{
			const EMassTrafficControllerSignType TrafficControllerSignType = ITempoIntersectionInterface::Execute_GetTempoTrafficControllerSignType(OwnerActor, ConnectionIndex);
...
void UTempoIntersectionControlComponent::SetupTrafficLightRuntimeData(AActor& OwnerActor, UMassTrafficControllerRegistrySubsystem& TrafficControllerRegistrySubsystem)
{
	...
	for (int32 ConnectionIndex = 0; ConnectionIndex < NumConnections; ++ConnectionIndex)
	{
		FTempoTrafficControllerMeshInfo TrafficControllerMeshInfo = ITempoIntersectionInterface::Execute_GetTempoTrafficControllerMeshInfo(&OwnerActor, ConnectionIndex, ETempoTrafficControllerType::TrafficLight);
		const FVector TrafficControllerLocation = ITempoIntersectionInterface::Execute_GetTempoTrafficControllerLocation(&OwnerActor, ConnectionIndex, ETempoTrafficControllerType::TrafficLight, ETempoCoordinateSpace::World);
		const FRotator TrafficControllerRotation = ITempoIntersectionInterface::Execute_GetTempoTrafficControllerRotation(&OwnerActor, ConnectionIndex, ETempoTrafficControllerType::TrafficLight, ETempoCoordinateSpace::World);
...
void UTempoIntersectionControlComponent::SetupTrafficSignRuntimeData(AActor& OwnerActor, UMassTrafficControllerRegistrySubsystem& TrafficControllerRegistrySubsystem)
{
	...
	{
		const FVector IntersectionEntranceLocation = ITempoIntersectionInterface::Execute_GetTempoIntersectionEntranceLocation(&OwnerActor, ConnectionIndex, ETempoCoordinateSpace::World);
		EMassTrafficControllerSignType TrafficControllerSignType = ITempoIntersectionInterface::Execute_GetTempoTrafficControllerSignType(&OwnerActor, ConnectionIndex);

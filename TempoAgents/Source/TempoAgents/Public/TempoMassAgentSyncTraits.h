...
class TEMPOAGENTS_API UTempoMassAgentBrightnessMeterSyncTrait : public UMassAgentSyncTrait
{
	GENERATED_BODY()
...
UCLASS()
class TEMPOAGENTS_API UTempoMassSceneComponentTransformToMassTranslator : public UMassTranslator
{
	GENERATED_BODY()
public:
...
class TEMPOAGENTS_API UMassAgentTransformSyncTrait : public UMassAgentSyncTrait
{
	GENERATED_BODY()
